...
export function EditorHeader() {
  ...
  const isDirty = useEditorStore(
    (state) => state.getActiveTab()?.isDirty ?? false,
  );
  ...
  return (
    <header className="flex h-[60px] shrink-0 items-center justify-between gap-4 border-b border-border bg-surface px-4">
      <div className="flex min-w-0 items-center gap-3">
        <div className="flex h-9 w-9 items-center justify-center rounded-[10px] bg-primary text-white shadow-sm">
        ...
        <label className="ml-4 flex min-w-[240px] max-w-sm items-center gap-2">
