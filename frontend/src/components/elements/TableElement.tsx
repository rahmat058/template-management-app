...
import {
  SortableTableRow,
  StaticTableRow,
} from "@/components/elements/table/SortableTableRow";
import { TableToolbar } from "@/components/elements/table/TableToolbar";
import {
  columnWidth,
  isIndexedTable,
} from "@/components/elements/table/table-layout";
            ...
            {headerRow.cells.map((cell, index) => (
              ...
              >
                <TableCellEditor
                  ...
                  onChange={(value) =>
                    mutate((current) =>
                      updateTableCell(current, headerRow.id, cell.id, value),
                    )
                  }
                />
              </th>
          ...
          interactive ? (
            <SortableTableRow
              ...
              onCellChange={(cellId, value) =>
                mutate((current) =>
                  updateTableCell(current, row.id, cellId, value),
                )
              }
            />
          ) : (
