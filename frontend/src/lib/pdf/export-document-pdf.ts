...
export async function downloadDocumentPdf(editorDocument: EditorDocument, name: string): Promise<void> {
  const [{ pdf }, { TemplatePdfDocument }, { collectPdfImages }] = await Promise.all([
