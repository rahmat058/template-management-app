...
export const FONT_FAMILIES = ['Inter', 'Arial', 'Helvetica', 'Georgia', 'Times New Roman'] as const
...
export type DocumentElement = TextElement | TableElement | ImageElement | ShapeElement
